    ...
    <main>
        <section >
          ...
          <div className="Intro-Item">
              <span><img src="../assets/images/bg/oil-refinery-plant-.jpg" alt="" /></span>
          </div>
            
            <div className="Intro-Item IntroWriteup">
              <p>Welcome to Original Pumps Inc </p>
              <h1>Empowering Industries with Original Pumps </h1>
              <br />
